...
const doctorAppointmentListSlice = createSlice({
...
export const { appointmentListRequest, appointmentListFail, appointmentListSuccess, appointmentUpdateRequest, appointmentUpdateFail, appointmentUpdateSuccess, appointmentUpdateMessageReset } = doctorAppointmentListSlice.actions;
...
export const selectDoctorAppointmentList = (state: RootState) => state.doctorAppointmentList;
export default doctorAppointmentListSlice.reducer;